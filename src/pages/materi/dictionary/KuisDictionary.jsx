...
export default function KuisDictionary() {
  ...
  // Handler untuk soal esai (input code)
    ...
    if (role === 'mahasiswa') {
      ...
      try {
        ...
        if (isPassed) {
          ...
          // Tambah progres hanya jika masih < 13
          if (!alreadyBonus && progresBelajar < 13) {
  ...
  const goToPreviousMaterial = () => {
    window.location.href = '/Dictionary/ManipulasiDictionary';
  };
    ...
    return (
      <div style={stylesMobile.fullscreenQuiz}>
        <div style={stylesMobile.quizHeader}>
          <div style={stylesMobile.quizTitle}>KUIS DICTIONARY</div>
